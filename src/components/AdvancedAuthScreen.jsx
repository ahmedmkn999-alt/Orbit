  ...
  const handleRequestOTP = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(result.message || 'فشل الاتصال بالخادم. تأكد من تشغيل Backend Server');
      }
    } catch (err) {
      console.error('Error in handleRequestOTP:', err);
      setError('خطأ في الاتصال بالخادم. تأكد من:\n1. تشغيل Backend على http://localhost:3000\n2. صحة VITE_API_URL في ملف .env');
    }
